...
<div style="font-family:Arial,Helvetica,sans-serif;background:#ffffff;padding:20px 24px;">
  ...
  <table cellpadding="0" cellspacing="0" style="border-collapse:collapse;margin-bottom:36px;">
    <tr>
      <td style="border:1px solid #d1d5db;padding:4px 16px;text-align:center;">
        <p style="margin:0;padding:0;font-size:18px;font-weight:700;color:#1d4ed8;line-height:1;">${records.length}</p>
        <p style="margin:2px 0 0;padding:0;font-size:10px;color:#6b7280;line-height:1;">Total Branches</p>
      </td>
      <td style="border:1px solid #d1d5db;border-left:0;padding:4px 16px;text-align:center;">
        <p style="margin:0;padding:0;font-size:18px;font-weight:700;color:#15803d;line-height:1;">${completed.length}</p>
        <p style="margin:2px 0 0;padding:0;font-size:10px;color:#6b7280;line-height:1;">Completed</p>
      </td>
      <td style="border:1px solid #d1d5db;border-left:0;padding:4px 16px;text-align:center;">
        <p style="margin:0;padding:0;font-size:18px;font-weight:700;color:#ea580c;line-height:1;">${pending.length}</p>
        <p style="margin:2px 0 0;padding:0;font-size:10px;color:#6b7280;line-height:1;">Pending</p>
      </td>
      <td style="border:1px solid #d1d5db;border-left:0;padding:4px 16px;text-align:center;">
        <p style="margin:0;padding:0;font-size:18px;font-weight:700;color:#b91c1c;line-height:1;">${notWorkingTotal}</p>
        <p style="margin:2px 0 0;padding:0;font-size:10px;color:#6b7280;line-height:1;">Not Working Cams</p>
      </td>
    </tr>
  </table>
